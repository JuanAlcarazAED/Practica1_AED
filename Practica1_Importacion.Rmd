...
\<font color="red"\>Para la impotación en realidad en mejor paquete es \`rio\`\<\\font\>
...
<font color="red">NO HACER NUNCA `x <- load("File.Rdata")`\<\font\>
...
texto <- toJSON(iris)
write_json(iris, path = "./iris_formato_JSON")
```
